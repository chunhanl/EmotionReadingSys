...
def create_Kao_Onet( weight_path ):
    ...
    print('Onet loading weights....')
    model.load_weights(weight_path, by_name=True)
    return model

def create_Kao_Rnet (weight_path ):
    ...
    print('Rnet loading weights....')
    model.load_weights(weight_path, by_name=True)
    return model

def create_Kao_Pnet( weight_path ):
